    ...
    <div class="product-view col-xs-12 col-sm-12 col-md-<?php echo $cols[1]; ?> col-lg-<?php echo $cols[1]; ?>">
        ...
        <div id="product" class="product-extra ">
            ...
            <div class="action pull-left">
                <div class="cart">
                    <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-shopping-cart"><?php if(isset($product['mkenqpro_flag']) && $product['mkenqpro_flag'] && $product['mkenqpro_btntype'] == 1) { ?> <?php echo $product['mkenqpro_btntext']; ?> <?php } else { ?> <?php echo $button_cart; ?> <?php } ?></button>
                </div>
                <div class="wishlist">  
