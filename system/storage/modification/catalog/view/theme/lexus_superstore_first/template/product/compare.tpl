   ...
   <div id="sidebar-main" class="col-md-<?php echo $SPAN[1];?>"><div id="content"><?php echo $content_top; ?>
      ...
      <table class="table table-bordered">
        ...
        <tr>
          <td></td>
          <?php foreach ($products as $product) { ?>
						<td class="text-center"><input type="button" value="<?php if(isset($product['mkenqpro_flag']) && $product['mkenqpro_flag'] && $product['mkenqpro_btntype'] == 1) { ?> <?php echo $product['mkenqpro_btntext']; ?> <?php } else { ?> <?php echo $button_cart; ?> <?php } ?>" class="button btn btn-primary" onclick="<?php if(isset($product['mkenqpro_flag']) && $product['mkenqpro_flag'] && $product['mkenqpro_btntype'] == 1) { ?> addtomkenqpro <?php } else { ?> cart.add <?php } ?>('<?php echo $product['product_id']; ?>');" /></td>
						<?php } ?>
					</tr>
					<tr>
						<td></td>
