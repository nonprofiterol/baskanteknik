      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          <tr>
            ...
            <?php foreach ($products as $product) { ?>
            <td><?php if(isset($product['mkenqpro_flag']) && $product['mkenqpro_flag'] && $product['mkenqpro_btntype'] == 2) { ?> 
        ...
        <tr>
          <td></td>
          <?php foreach ($products as $product) { ?>
          <td><input type="button" value="<?php if(isset($product['mkenqpro_flag']) && $product['mkenqpro_flag'] && $product['mkenqpro_btntype'] == 1) { ?> <?php echo $product['mkenqpro_btntext']; ?> <?php } else { ?> <?php echo $button_cart; ?> <?php } ?>" class="btn btn-primary btn-block" onclick="<?php if(isset($product['mkenqpro_flag']) && $product['mkenqpro_flag'] && $product['mkenqpro_btntype'] == 1) { ?> addtomkenqpro <?php } else { ?> cart.add <?php } ?>('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');" />
