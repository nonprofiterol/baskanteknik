      ...
      <div class="table-responsive">
        <table class="table table-bordered table-hover">
          ...
          <tbody>
			...
			<?php } ?>
			<button type="button" onclick="<?php if(isset($product['mkenqpro_flag']) && $product['mkenqpro_flag'] && $product['mkenqpro_btntype'] == 1) { ?> addtomkenqpro <?php } else { ?> cart.add <?php } ?>('<?php echo $product['product_id']; ?>');" data-toggle="tooltip" title="<?php if(isset($product['mkenqpro_flag']) && $product['mkenqpro_flag'] && $product['mkenqpro_btntype'] == 1) { ?> <?php echo $product['mkenqpro_btntext']; ?> <?php } else { ?> <?php echo $button_cart; ?> <?php } ?>" class="btn btn-primary"><?php if(isset($product['mkenqpro_flag']) && $product['mkenqpro_flag'] && $product['mkenqpro_btntype'] == 1) { ?> <i class="fa fa-envelope"></i> <?php } else { ?> <i class="fa fa-shopping-cart"></i> <?php } ?></button>
