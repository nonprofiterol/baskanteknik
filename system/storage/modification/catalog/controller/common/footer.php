...
class ControllerCommonFooter extends Controller {
    public function index() {
  			$data['mkenqpro_module'] = (substr(VERSION,0,3)>='3.0' || substr(VERSION,0,3)=='2.3') ? $this->load->controller('extension/module/mkenqpro') : $this->load->controller('module/mkenqpro');
