...
<div id="content">
  ...
  <div id="sendenquirymail_model" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title"><?php echo $enquiry_email_heading;?></h4>
      </div>
      <div class="modal-body"> </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo $btn_close;?></button>
...
function sendenquirymail(mkenqpro_id) {
	$('#sendenquirymail_model').modal('show');

 	$.ajax({
		url: 'index.php?route=<?php echo $modpath;?>/sendenquirymail&token=<?php echo $token; ?>',
		type: 'post',
		data: { mkenqpro_id : mkenqpro_id },
		dataType: 'html',
		beforeSend: function() {
			$('#sendenquirymail_model .modal-body').html('loading');
		},
		success: function(response) {
			$('#sendenquirymail_model .modal-body').html(response);
		},
